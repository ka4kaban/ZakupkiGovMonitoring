...
namespace ParseXmlProj
{
    ...
    [XmlRoot(ElementName = "purchaseProtocolData", Namespace = "http://zakupki.gov.ru/223fz/purchase/1")]
    public class PurchaseProtocolData
    {
        [Key]
    ...
    [XmlRoot(ElementName = "purchaseProtocol", Namespace = "http://zakupki.gov.ru/223fz/purchase/1")]
